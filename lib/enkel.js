...
module.exports = class {
  ...
  createSocketServer () {
    ...
    if (_socketConfig.type === 'wss') {
      ...
      let keypath = _socketConfig.key || path.resolve(process.cwd(), '../../../etc/letsencrypt/live/dei2.com/privkey.pem');
      let certpath = _socketConfig.cert || path.resolve(process.cwd(), '../../../etc/letsencrypt/live/dei2.com/cert.pem');
      let sslOptions = {
